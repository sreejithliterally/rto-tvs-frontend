      ...
      <form className="customer-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <input
            ...
            value={formData.ex_showroom_price || 0}
            onChange={onInputChange}
            required
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            value={formData.tp_registration || 0}
            onChange={onInputChange}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            value={formData.man_accessories || 0}
            onChange={onInputChange}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            value={formData.optional_accessories || 0}
            onChange={onInputChange}
          />
        </div>
